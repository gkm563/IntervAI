...
CREATE TABLE IF NOT EXISTS users (
    ...
    status VARCHAR(50) NOT NULL DEFAULT 'UNVERIFIED', -- 'UNVERIFIED', 'ACTIVE', 'SUSPENDED'
    email_verified_at TIMESTAMPTZ NULL,
    avatar_url TEXT NULL,
    role VARCHAR(50) NOT NULL DEFAULT 'USER', -- 'USER', 'ADMIN', 'COACH'
...
-- ----------------------------------------------------------------------------
-- 7. Future Core Entity Tables Stubs (Milestone 2+ Foundation)
-- ----------------------------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS resumes (
    ...
    status VARCHAR(50) NOT NULL DEFAULT 'UPLOADED', -- 'UPLOADED', 'PARSING', 'PARSED', 'FAILED'
...
CREATE TABLE IF NOT EXISTS interviews (
    ...
    target_company VARCHAR(255) NULL,
    mode VARCHAR(50) NOT NULL DEFAULT 'TEXT', -- 'TEXT', 'VOICE', 'VIDEO'
    difficulty VARCHAR(50) NOT NULL DEFAULT 'MEDIUM', -- 'EASY', 'MEDIUM', 'HARD'
    status VARCHAR(50) NOT NULL DEFAULT 'CREATED', -- 'CREATED', 'IN_PROGRESS', 'COMPLETED', 'ABANDONED'
...
CREATE TABLE IF NOT EXISTS interview_questions (
    ...
    category VARCHAR(100) NOT NULL DEFAULT 'TECHNICAL', -- 'TECHNICAL', 'BEHAVIORAL', 'RESUME', 'SYSTEM_DESIGN'
...
-- Notifications (System & Alert Hub)
CREATE TABLE IF NOT EXISTS notifications (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    user_id UUID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
    title VARCHAR(255) NOT NULL,
    message TEXT NOT NULL,
    type VARCHAR(50) NOT NULL DEFAULT 'SYSTEM', -- 'AUTH', 'SYSTEM', 'INTERVIEW', 'PRACTICE'
