...
export const ProblemAgitation: React.FC = () => {
  ...
  return (
    <section className="py-20 bg-[#070F22] border-t border-slate-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
          <h2 className="text-xs uppercase font-bold tracking-widest text-sky-400">The Problem</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {problems.map((prob, idx) => {
            ...
            return (
              <div
                key={idx}
                className="glass-card rounded-2xl p-8 relative overflow-hidden group hover:border-slate-700 transition-all"
              >
                <div className="flex items-center justify-between mb-6">
                  <div className="w-12 h-12 rounded-xl bg-slate-800/90 border border-slate-700/80 flex items-center justify-center text-sky-400 group-hover:scale-110 group-hover:bg-sky-500/10 transition-all">
