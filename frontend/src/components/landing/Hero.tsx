      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            ...
            {/* Top Badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-sky-500/10 border border-sky-500/20 text-xs font-semibold text-sky-500 shadow-sm">
              <span className="w-2 h-2 rounded-full bg-sky-500 animate-pulse"></span>
              <span>AI-Powered Real-Time Interview Simulation</span>
            </div>

            {/* Main Headline */}
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 dark:text-white leading-[1.1] font-['Plus_Jakarta_Sans',sans-serif]">
              Practice interviews with an AI that{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-500 via-sky-400 to-indigo-500">
                actually knows
              </span>{' '}
              your resume.
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2">
              ...
              <a
                href="#demo"
                className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-semibold text-sm text-slate-700 dark:text-slate-200 bg-slate-100 dark:bg-slate-800/80 hover:bg-slate-200 dark:hover:bg-slate-700/80 border border-slate-300 dark:border-slate-700 transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="absolute -inset-1.5 bg-gradient-to-r from-sky-500 to-indigo-600 rounded-2xl blur-lg opacity-25 animate-pulse-subtle"></div>

              {/* Main Card */}
              <div className="relative rounded-2xl bg-white dark:bg-[#0B1B3A] border border-slate-200 dark:border-slate-700/80 shadow-2xl p-6 overflow-hidden">
                ...
                <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-4 mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400">Targeting: SDE-1 / Frontend Engineer</p>
                    </div>
                  </div>

                  <div className="flex items-center gap-1 bg-slate-50 dark:bg-slate-900/80 px-2.5 py-1 rounded-full border border-slate-200 dark:border-slate-800 text-[11px] text-emerald-500 dark:text-emerald-400 font-medium">
                ...
                <div className="space-y-3 mb-5">
                  <div className="bg-slate-50 dark:bg-slate-900/90 rounded-xl p-3.5 border border-slate-200 dark:border-slate-800/80 text-sm">
                  ...
                  <div className="bg-sky-50 dark:bg-sky-950/40 rounded-xl p-3.5 border border-sky-200 dark:border-sky-800/30 text-sm ml-4">
                ...
                <div className="bg-slate-50 dark:bg-slate-900/60 rounded-xl p-3 border border-slate-200 dark:border-slate-800 space-y-2">
                  <div className="flex items-center justify-between text-xs">
                    <span className="text-slate-500 dark:text-slate-400 font-medium">Real-Time Evaluation</span>
                    <span className="text-emerald-600 dark:text-emerald-400 font-bold">Strong Technical Depth (92%)</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400 pt-1">
                    <span className="flex items-center gap-1"><Mic className="w-3 h-3 text-sky-500" /> Natural Cadence</span>
                    <span className="flex items-center gap-1"><CheckCircle2 className="w-3 h-3 text-emerald-500" /> Resume Verified</span>
                  </div>
                </div>

                {/* Modality Icons Bar */}
                <div className="flex items-center justify-around pt-4 border-t border-slate-100 dark:border-slate-800 text-[11px] text-slate-500 dark:text-slate-400 font-medium">
