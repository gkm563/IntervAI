...
import { Bot, Mail, KeyRound, AlertCircle, CheckCircle2, ArrowLeft, Send } from 'lucide-react';
            ...
            <div className="space-y-5 text-center">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-slate-300 leading-relaxed">
                  If an account exists with <strong className="text-sky-400">{email}</strong>, we have sent a secure password reset link to that inbox.
                </p>
                <p className="text-[11px] text-slate-500">
                  Please check your spam or promotions folder if you do not see it within 2 minutes. The link expires in 30 minutes.
                </p>
              </div>
